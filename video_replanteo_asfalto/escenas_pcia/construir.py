...
SCENES = [
    ...
    dict(id="paso6", short="Paso 6", title="Paso 6 · Triángulo inferior", group="Plano 1", caps=[
        ...
        ("La recta que une los cruces corta M1E en su punto medio O. Con el cordel a 1 metro desde O, giramos y marcamos el semicírculo.",
         "La recta que une los cruces corta eme uno e en su punto medio, o. Con el cordel a un metro desde o, giramos y marcamos el semicírculo."),
    ]),
    dict(id="paso7", short="Paso 7", title="Paso 7 · Triángulo derecho", group="Plano 1", caps=[
        ...
        ("Donde la recta de los cruces corta FB está O. Con el cordel a 1,33 metros, marcamos el semicírculo.",
         "Donde la recta de los cruces corta efe be está o. Con el cordel a uno treinta y tres, marcamos el semicírculo."),
    ]),
    dict(id="paso8", short="Paso 8", title="Paso 8 · Triángulo izquierdo", group="Plano 1", caps=[
        ...
        ("La recta de los cruces corta JD en O. Con el cordel a 1,33 metros, marcamos el semicírculo.",
         "La recta de los cruces corta jota de en o. Con el cordel a uno treinta y tres, marcamos el semicírculo."),
    ]),
    dict(id="paso9", short="Paso 9", title="Paso 9 · Triángulo superior", group="Plano 1", caps=[
        ...
        ("Donde la recta de los cruces corta GI está O. Con el cordel a 1,18 metros, marcamos el semicírculo.",
         "Donde la recta de los cruces corta ge i está o. Con el cordel a uno dieciocho, marcamos el semicírculo."),
    ]),
