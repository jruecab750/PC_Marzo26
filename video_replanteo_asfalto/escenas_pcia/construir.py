...
SCENES = [
    ...
    dict(id="paso9", short="Paso 9", title="Paso 9 · Triángulo superior", group="Plano 1", caps=[
        ...
        ("La recta de los cruces ya es perpendicular a M3G y pasa por H. Sobre ella, desde H, medimos 2 metros hacia la derecha: el punto I.",
         "La recta de los cruces ya es perpendicular a eme tres ge, y pasa por hache. Sobre ella, desde hache, medimos dos metros hacia la derecha: el punto i."),
